...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        await uploadString(imageRef, selectedFile, "data_url").then(async snapshot => {
            const downloaURL = await getDownloadURL(imageRef);
  ...
  return (
    <Transition.Root show={open} as={Fragment}>
        ...
        onClose={setOpen}
        >
            <div className='flex items-end justify-start min-h-[800px] sm:min-h-screen
                ...
                >
                    ...
                    transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6'>
                        <div>
                            ...
                            rounded-full bg-purple-100 cursor-pointer"
                            >
                                <CameraIcon 
                            ...
                            <div className='mt-5 sm:mt-6'>
                                <button
                                    ...
                                    border border-transparent shadow-md px-4 py-2 bg-purple-600
                                    text-base font-medium text-white hover:bg-purple-700 focus:outline-none
                                    focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 sm:text-sm disabled:bg-gray-300
